...
# Full country data: (Code, Sort Order, Name, Description, Remark)
countries = [
    ("AC", 1, "ASCENSION ISLAND", "ASCENSION ISLAND", ""),
    ("AD", 2, "ANDOZRA", "ANDOZRA", ""),
    ("AE", 3, "UNITED ARAB EMIRATES", "UNITED ARAB EMIRATES", ""),
    ("AG", 4, "ANTIGUA AND BARBUDA", "ANTIGUA AND BARBUDA", ""),
    ("AI", 5, "ANGUILLA", "ANGUILLA", ""),
    ("AL", 6, "ALBANIA", "ALBANIA", ""),
    ("AM", 7, "ARMENIA", "ARMENIA", ""),
    ("AN", 8, "NETHERLANDS ANTILLES", "NETHERLANDS ANTILLES", ""),
    ("AO", 9, "ANGOLA", "ANGOLA", ""),
    ...
    ("BA", 18, "BOSNIA AND HERZEGOVINA", "BOSNIA AND HERZEGOVINA", ""),
    ...
    ("BN", 28, "BRUNEI DARUSSALAM", "BRUNEI DARUSSALAM", ""),
    ...
    ("BZ", 36, "BELIZE", "BELIZE", ""),
    ("CA", 37, "CANADA", "CANADA", ""),
    ("CC", 38, "COCOS (KEELING) ISLANDS", "COCOS (KEELING) ISLANDS", ""),
    ("CD", 39, "CONGO, DEMOCRATIC REPUBLIC", "CONGO, DEMOCRATIC REPUBLIC", ""),
    ("CF", 40, "CENTRAL AFRICAN REPUBLIC", "CENTRAL AFRICAN REPUBLIC", ""),
    ("CG", 41, "CONGO", "CONGO", ""),
    ("CH", 42, "SWITZERLAND", "SWITZERLAND", ""),
    ("CI", 43, "COTE D'IVOIRE (IVORY COAST)", "COTE D'IVOIRE (IVORY COAST)", ""),
    ...
    ("CS", 50, "CZECHOSLOVAKIA (FORMER)", "CZECHOSLOVAKIA (FORMER)", ""),
    ("CU", 51, "CUBA", "CUBA", ""),
    ...
    ("DO", 60, "DOMINICAN REPUBLIC", "DOMINICAN REPUBLIC", ""),
    ...
    ("FJ", 71, "FIJI", "FIJI", ""),
    ("FK", 72, "FALKLAND ISLANDS (MALVINAS)", "FALKLAND ISLANDS (MALVINAS)", ""),
    ("FM", 73, "MICRONESIA", "MICRONESIA", ""),
    ("FO", 74, "FAROE ISLANDS", "FAROE ISLANDS", ""),
    ("FR", 75, "FRANCE", "FRANCE", ""),
    ("FX", 76, "FRANCE, METROPOLITAN", "FRANCE, METROPOLITAN", ""),
    ("GA", 77, "GABON", "GABON", ""),
    ...
    ("GR", 90, "GREECE", "GREECE", ""),
    ("GS", 91, "S. GEORGIA AND S. SANDWICH ISLS.", "S. GEORGIA AND S. SANDWICH ISLS.", ""),
    ("GT", 92, "GUATEMALA", "GUATEMALA", ""),
    ("GU", 93, "GUAM", "GUAM", ""),
    ("GW", 94, "GUINEA BISSAU", "GUINEA BISSAU", ""),
    ("GY", 95, "GUYANA", "GUYANA", ""),
    ("HK", 96, "HONG KONG", "HONG KONG", ""),
    ("HM", 97, "HEARD AND MCDONALD ISLANDS", "HEARD AND MCDONALD ISLANDS", ""),
    ...
    ("IN", 106, "INDIA", "INDIA", ""),
    ("IO", 107, "BRITISH INDIAN OCEAN TERRITORY", "BRITISH INDIAN OCEAN TERRITORY", ""),
    ("IQ", 108, "IRAQ", "IRAQ", ""),
    ("IR", 109, "IRAN", "IRAN", ""),
    ...
    ("KN", 121, "SAINT KITTS AND NEVIS", "SAINT KITTS AND NEVIS", ""),
    ...
    ("MK", 144, "F.Y.R.O.M. (MACEDONIA)", "F.Y.R.O.M. (MACEDONIA)", ""),
    ("ML", 145, "MALI", "MALI", ""),
    ("MM", 146, "MYANMAR", "MYANMAR", ""),
    ("MN", 147, "MONGOLIA", "MONGOLIA", ""),
    ("MO", 148, "MACAU", "MACAU", ""),
    ("MP", 149, "NORTHERN MARIANA ISLANDS", "NORTHERN MARIANA ISLANDS", ""),
    ...
    ("NU", 171, "NIUE", "NIUE", ""),
    ("NZ", 172, "NEW ZEALAND (AOTEAROA)", "NEW ZEALAND (AOTEAROA)", ""),
    ("OM", 173, "OMAN", "OMAN", ""),
    ...
    ("PM", 181, "ST. PIERRE AND MIQUELON", "ST. PIERRE AND MIQUELON", ""),
    ("PN", 182, "PITCAIRN", "PITCAIRN", ""),
    ("PR", 183, "PUERTO RICO", "PUERTO RICO", ""),
    ("PS", 184, "PALESTINIAN TERRITORY, OCCUPIED", "PALESTINIAN TERRITORY, OCCUPIED", ""),
    ...
    ("RU", 192, "RUSSIAN FEDERATION", "RUSSIAN FEDERATION", ""),
    ...
    ("SJ", 202, "SVALBARD & JAN MAYEN ISLANDS", "SVALBARD & JAN MAYEN ISLANDS", ""),
    ...
    ("ST", 209, "SAO TOME AND PRINCIPE", "SAO TOME AND PRINCIPE", ""),
    ("SU", 210, "USSR (FORMER)", "USSR (FORMER)", ""),
    ("SV", 211, "EL SALVADOR", "EL SALVADOR", ""),
    ("SY", 212, "SYRIA", "SYRIA", ""),
    ("SZ", 213, "SWAZILAND", "SWAZILAND", ""),
    ("TC", 214, "TURKS AND CAICOS ISLANDS", "TURKS AND CAICOS ISLANDS", ""),
    ("TD", 215, "CHAD", "CHAD", ""),
    ("TF", 216, "FRENCH SOUTHERN TERRITORIES", "FRENCH SOUTHERN TERRITORIES", ""),
    ("TG", 217, "TOGO", "TOGO", ""),
    ...
    ("TT", 226, "TRINIDAD AND TOBAGO", "TRINIDAD AND TOBAGO", ""),
    ...
    ("UM", 233, "US MINOR OUTLYING ISLANDS", "US MINOR OUTLYING ISLANDS", ""),
    ("US", 234, "UNITED STATES", "UNITED STATES", ""),
    ("UY", 235, "URUGUAY", "URUGUAY", ""),
    ("UZ", 236, "UZBEKISTAN", "UZBEKISTAN", ""),
    ("VA", 237, "VATICAN CITY STATE (HOLY SEE)", "VATICAN CITY STATE (HOLY SEE)", ""),
    ("VC", 238, "SAINT VINCENT & THE GRENADINES", "SAINT VINCENT & THE GRENADINES", ""),
    ("VE", 239, "VENEZUELA", "VENEZUELA", ""),
    ("VG", 240, "BRITISH VIRGIN ISLANDS", "BRITISH VIRGIN ISLANDS", ""),
    ("VI", 241, "VIRGIN ISLANDS (U.S.)", "VIRGIN ISLANDS (U.S.)", ""),
    ("VN", 242, "VIET NAM", "VIET NAM", ""),
    ("VU", 243, "VANUATU", "VANUATU", ""),
    ("WF", 244, "WALLIS AND FUTUNA ISLANDS", "WALLIS AND FUTUNA ISLANDS", ""),
    ("WS", 245, "SAMOA", "SAMOA", ""),
    ("YE", 246, "YEMEN", "YEMEN", ""),
    ("YT", 247, "MAYOTTE", "MAYOTTE", ""),
    ("YU", 248, "SERBIA AND MONTENEGRO (FORMER)", "SERBIA AND MONTENEGRO (FORMER)", ""),
    ("ZA", 249, "SOUTH AFRICA", "SOUTH AFRICA", ""),
    ("ZM", 250, "ZAMBIA", "ZAMBIA", ""),
    ("ZR", 251, "(ZAIRE) SEE CD CONGO, DEMOCRATIC REPUBLIC", "(ZAIRE) SEE CD CONGO, DEMOCRATIC REPUBLIC", ""),
...
fixture = [
    ...
    for idx, (code, sort_order, name, description, remark) in enumerate(countries)
]

with open("countries_fixture.json", "w", encoding="utf-8") as f:
    json.dump(fixture, f, indent=2, ensure_ascii=False)

print("countries_fixture.json generated successfully!")
